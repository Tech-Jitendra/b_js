...
const features = [
    {
        ...
        description: 'Detailed product descriptions, high-quality images, and advanced filters for effortless navigation.',
        image: 'https://images.pexels.com/photos/6850549/pexels-photo-6850549.jpeg?auto=compress&cs=tinysrgb&w=600',
        animation: 'animate__zoomIn',
    },
    {
        title: 'Shopping Cart',
        description: 'Easy-to-use virtual shopping cart with a secure checkout process and multiple payment options.',
        image: 'https://images.pexels.com/photos/5632398/pexels-photo-5632398.jpeg?auto=compress&cs=tinysrgb&w=600',
        animation: 'animate__zoomIn',
    },
    {
        title: 'User Profiles',
        description: 'Manage orders, track shipments, and enjoy a personalized shopping experience with wishlists and order history.',
        image: 'https://images.pexels.com/photos/7552562/pexels-photo-7552562.jpeg?auto=compress&cs=tinysrgb&w=600',
        animation: 'animate__zoomIn',
    },
];
                ...
                <Row gutter={[16, 16]} justify="center">
                    {features.map((feature, index) => (
                        <Col span={8} key={index}>
                            <Card
                                hoverable
                                className={`feature-card animate__animated ${feature.animation}`}
                ...
                <Row gutter={[16, 16]} justify="center">
                    {benefits.map((benefit, index) => (
                        <Col span={6} key={index}>
                            <Card hoverable className={`benefit-card animate__animated ${benefit.animation}`}>
                                <h4>{benefit.title}</h4>
